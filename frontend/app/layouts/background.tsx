// View3D/app/components/Background.tsx
  ...
  return (
    <BackgroundWrapper>
      <div className="relative h-screen w-full overflow-hidden bg-gray-900">
        <div className="cube-scene absolute inset-0 perspective-1000 transform-style-preserve-3d"></div>
      </div>
    </BackgroundWrapper>
  );
}
  ...
  return (
    <BackgroundWrapper>
      <div className="relative h-screen w-full overflow-hidden">
        <div className="cube-container absolute inset-0 perspective-[1000]">
          <div className="cube relative w-64 h-64 mx-auto mt-32 transform-3d animate-[spin_20s_linear_infinite]">
            <div className="absolute w-full h-full bg-blue-500/50 border-2 border-blue-300 translate-z-[80px]"></div>
            <div className="absolute w-full h-full bg-purple-500/50 border-2 border-purple-300 rotate-y-180 translate-z-[0px]"></div>
            <div className="absolute w-full h-full bg-green-500/50 border-2 border-green-300 rotate-y-90 translate-z-[16px]"></div>
            <div className="absolute w-full h-full bg-red-500/50 border-2 border-red-300 rotate-y-270 translate-z-[32px]"></div>
            <div className="absolute w-full h-full bg-yellow-500/50 border-2 border-yellow-300 rotate-y-90 translate-z-[48px]"></div>
            <div className="absolute w-full h-full bg-pink-500/50 border-2 border-pink-300 rotate-y-270 translate-z-[64px]"></div>
          </div>
        </div>
      </div>
    </BackgroundWrapper>
    ...
    <BackgroundWrapper>
      <div className="relative h-screen w-full overflow-hidden bg-gray-900">
        ...
        <div className="relative z-10 flex items-center justify-center h-full text-white">
          <h1 className="text-4xl font-bold">炫酷3D背景</h1>
        </div>
      </div>
    </BackgroundWrapper>
  );
